...
public class Page {
     ...
     */
    private Collection<Document> items;
    /**
     * 当前显示起始索引(从零开始计算)
     */
    ...
    public Collection<Document> getItems() {
        return items;
    }

    public void setItems(Collection<Document> items) {
        this.items = items;
    }
    ...
    public Page(int currentPage, int pageSize, Collection<Document> items) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
        this.items = items;
    }

    public Page(int currentPage, int pageSize, Collection<Document> items, int groupSize) {
        this.currentPage = currentPage;
        this.pageSize = pageSize;
        this.items = items;
        this.groupSize = groupSize;
    ...
    public static void main(String[] args) {
        Collection<Document> items = new ArrayList();
        int totalRecord = 201;
