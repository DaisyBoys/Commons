 ...
 * **/
public final class ReqSearchSpecial {
    ...
    private int pageSize=5000;//翻页尺寸
    private ReqSearchResultSpecial pReqSearchResult=new ReqSearchResultSpecial();//记录结果集
	
	public ReqSearchResultSpecial getPReqSearchResult() {
		return pReqSearchResult;
	}
	public void setPReqSearchResult(ReqSearchResultSpecial reqSearchResult) {
	 ...
	 * */
	public String getQueryTermValue(String name){
		try{
			Object obj=mapQueryTerm.get(name);
	 ...
	 * @return 
	 * */
	public void SetQuerySQL(String selField,String from,String where,String orderby,String groupby){
	...
	//得到所有的页数
	private int GetTotalPageCnt(int nTotal,int nPageSize){
	...
	//设置翻页地址
	public void setPageLink(int nCurrPage,int nTotalPage){
	...
	//执行
	public ReqSearchResultSpecial runReq(){
		getDBQueryResult();
		return this.getPReqSearchResult();
	}
	
	@SuppressWarnings("unchecked")
	public List doQueryByJson(int nPage,int nPageSize){
		return getDBQueryResultByJson( nPage, nPageSize);
	}

	@SuppressWarnings("unchecked")
	public List getDBQueryResultByJson(int nPage,int nPageSize){
	...
	//==页面分组处理
	private void setListPageGroup(int nCurrPage,int nTotalPage,String strLink,String pageName){
		try {
	 ...
	 * */
	@SuppressWarnings("unchecked")
	public List getListJsonMap(Map<String,Object> mapJson){
		///this.setCurrPage(nPage);
		//this.setPageSize(nPageSize);
		List rtnList=new ArrayList();
		//得到记录总是
...
//			mapParam.put("nTotalPage", nPageCnt);
	...
	//执行
	public ReqSearchResultSpecial runReqJsonMap(Map<String,Object> mapJson){
	...
	public static void main(String[] args) {
		...
		ReqSearchSpecial pReqSearch =new ReqSearchSpecial();
