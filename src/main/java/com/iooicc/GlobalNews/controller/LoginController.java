...
import com.iooicc.GlobalNews.async.EventProducer;
    ...
    public String reg(Model model, @RequestParam("username") String username,
        ...
        try {
            ...
            if (map.containsKey("ticket")) {
                ...
                return GlobalNewsUtil.getJSONString(0, "注册成功");
            } else {
                return GlobalNewsUtil.getJSONString(1, map);
            }

        } catch (Exception e) {
            logger.error("注册异常" + e.getMessage());
            return GlobalNewsUtil.getJSONString(1, "注册异常");
        }
    }
    ...
    public String login(Model model, @RequestParam("username") String username,
        ...
        try {
            ...
            if (map.containsKey("ticket")) {
                ...
                return GlobalNewsUtil.getJSONString(0, "成功");
            } else {
                return GlobalNewsUtil.getJSONString(1, map);
            }
