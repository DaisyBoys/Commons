...
import webtools.HTTPJSON.tools.RSUpdateMsg;
...
public final class GsonMapMgr {
     ...
     * 错误信息处理
     */
    public String setErr(Map<String, Object> mapRtn, String errTitle, String fieldID, ReqEditForm pReqEditForm, RSUpdateMsg pRSUpdateMsg) {
        String errorMsg = errTitle;
        try {

            mapRtn.put("status", "1");
            mapRtn.put("errorMsg", errorMsg);
            Map<String, String> mapErr = new ConcurrentHashMap<String, String>();
            pReqEditForm.setMapErr(mapErr);
            mapErr.put(fieldID, errTitle);
            List<Map<String, Object>> dataErrList = pRSUpdateMsg.getListErrMap(pReqEditForm);
            mapRtn.put("dataErrList", dataErrList);
